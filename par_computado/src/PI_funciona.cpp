...
namespace par_computado_ns
{
    ...
    class ParComputado : public controller_interface::Controller<hardware_interface::EffortJointInterface>
    {
        ...
        double kp1 = 10, kp2 = 10, kp3 = 10, kp4 = 10, kp5 = 10, kp6 = 10;
        double kv1 = 10, kv2 = 10, kv3 = 10, kv4 = 10, kv5 = 10, kv6 = 10;
        ...
        void update(const ros::Time &time, const ros::Duration &duration)
        {
            ...
            // std::cout << "articulacion: " << i << "  " << U << "   " << joints_[i].getPosition() << std::endl;
            // std::cout << "error_integral: " << i << "  " << error_integral << "error: " << i << "  " << error << std::endl;
            // std::cout << T << std::endl;

            // if(action_torque){
            //     std::cout << "articulacion par_computado:" << i << "   " << torque[i][0] << "   " << qr[i][0] << "   " << q[i][0] << std::endl;
            //     joints_[i].setCommand(torque[i][0]);
            // }
            // else{
            //     std::cout << "articulacion ini:" << i << "   " << torque_ini[i][0] << "   " << qr[i][0] << "   " << q[i][0] << std::endl;
            //     joints_[i].setCommand(torque_ini[i][0]);
            // }
